import{n as e}from"./rolldown-runtime-S-ySWqyJ.js";import{g as t,v as n}from"./content-cases-DBTnyHr2.js";var ee=e({default:()=>ne,frontmatter:()=>te}),r=t(),te={title:`A/B 테스트 멈춤 신호 — 통계적 유의성 도달 전에 끝내야 할 때`,growth:`Budding`,topics:[`data`,`experiment`,`decision`,`product`],summary:`A/B 테스트는 '유의성 도달까지 기다리기'가 디폴트로 알려져 있지만, 실무에서는 유의성 도달 전에 멈춰야 하는 신호가 더 자주 발생한다. 5가지 신호와 멈춤 결정 프레임.`,plantedAt:`2026-05-28`,lastTendedAt:`2026-05-28`};function i(e){let t={a:`a`,blockquote:`blockquote`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h2,{children:`디폴트 가정`}),`
...
`,(0,r.jsx)(t.a,{href:`/cases/automation-poc-design`,children:`/cases/automation-poc-design`}),` — 거버넌스 부담을 평가한 자동화 PoC 케이스`]})]})}function _e(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(l,{...e})}):l(e)}var ve=e({default:()=>be,frontmatter:()=>ye}),ye={title:`chalk + boxen으로 터미널 시각 카드 — ANSI fallback까지`,growth:`Budding`,topics:[`cli`,`npm`,`terminal`,`design`],summary:`터미널은 평면 텍스트가 아니다. chalk(색)·boxen(박스)·figlet(ASCII art)로 잡지(magazine) 같은 카드. NO_COLOR·width 변동·이모지 깨짐 대비.`,plantedAt:`2026-05-11`,lastTendedAt:`2026-05-29`};function u(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h2,{children:`문제 — 터미널 출력은 보통 plain하다`}),`
...
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsxs)(t.strong,{children:[`Apartments_`,REGION]}),` × 5: 지역별 단지 정보 (정적)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsxs)(t.strong,{children:[`PriceSnapshots_`,YEAR]}),`: 가격 시계열 (year-partition)`]}),`
...
`]}),`
`,(0,r.jsx)(t.h2,{children:`관련`}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.a,{href:`/notes/automation-vs-governance`,children:`/notes/automation-vs-governance`}),` — 자동 발행은 one-way라 4주 dry-run 필수
...
`,(0,r.jsx)(t.p,{children:`이게 PR 100개 중 70개의 현실입니다. 그러면 리뷰어가 코드를 보면서 "이게 무슨 의도지?"를 추측해야 합니다. 추측이 틀리면 잘못된 리뷰가 갑니다.`}),`
...
`})}),`
`,(0,r.jsx)(t.p,{children:`이렇게 적는 데 5분 정도 걸립니다. 리뷰어는 본문 보고 어디부터 코드 읽을지 결정할 수 있습니다. 본문이 없는 PR보다 30분 빠른 머지.`}),`
`,(0,r.jsx)(t.h2,{children:`누가 가장 큰 이득인가`}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`6개월 후의 자기 자신`}),`. PR 본문이 commit message보다 더 풍부합니다. `,(0,r.jsx)(t.code,{children:`git blame`}),` → PR 링크 → 본문 → "아, 이 결정의 근거가 이거였구나."`]}),`
`,(0,r.jsx)(t.p,{children:`코드만 보면 절대 안 보이는 컨텍스트가 PR 본문에 살아남습니다.`}),`
`,(0,r.jsx)(t.h2,{children:`함정`}),`
`,(0,r.jsxs)(t.ul,{children:[`
...
`,(0,r.jsx)(t.a,{href:`/notes/dev-warning-noise-cost`,children:`/notes/dev-warning-noise-cost`}),` — 검사를 CI 차단으로 격상하는 패턴`]})]})}function Ir(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(Fr,{...e})}):Fr(e)}var Lr=e({default:()=>Br,frontmatter:()=>Rr}),Rr={title:`HTML 리포트와 binary asset 분리 저장소 — diff 노이즈·clone 시간 ↓`,growth:`Seedling`,topics:[`github`,`repo-structure`,`infrastructure`],summary:`본 repo는 가볍게(markdown·source), asset은 별도 저장소(Releases). cross-repo 참조 한 줄로 clone 5분이 10초가 된다.`,plantedAt:`2026-05-12`,lastTendedAt:`2026-05-21`};function zr(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h2,{children:`문제 — repo가 binary로 무거워진다`}),`
...
`]}),`
`,(0,r.jsxs)(t.p,{children:[`답은 "둘 다", "상황에 따라" 같은 정답 회피가 아닙니다. `,(0,r.jsx)(t.strong,{children:`각자 잘 잡는 영역이 다릅니다.`})]}),`
...
`})}),`
`,(0,r.jsx)(t.p,{children:`타입은 컴파일 시점, 테스트는 런타임. 둘이 다른 시점에서 다른 종류를 잡습니다.`}),`
...
`,(0,r.jsx)(t.p,{children:`TypeScript 통과 → 빌드 통과 → "이제 안전" 직관. 자주 틀립니다.`}),`
...
`})}),`
`,(0,r.jsx)(t.p,{children:`타입은 컴파일 시 시점의 정적 약속. 런타임 데이터가 타입을 만족한다는 보장은 아닙니다.`}),`
...
`,(0,r.jsxs)(t.p,{children:[`타입이 무용한 게 아닙니다. 다만 `,(0,r.jsx)(t.strong,{children:`타입의 범위를 알고 쓰는 것`}),`이 중요합니다.`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
