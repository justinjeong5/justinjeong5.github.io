...
`,(0,i.jsx)(t.h2,{children:`회고`}),`
`,(0,i.jsx)(t.p,{children:`평균이 아니라 최저 항목이 통과를 결정한다. 한 항목만 3점이어도 전체가 FAIL이다. 그래서 이 루프가 좋았다 — 내가 보고 싶은 것만 보지 않게, 가장 약한 곳을 매번 먼저 들이밀었다. 모바일은 디테일의 누적이고, 8축 중 하나만 빠져도 사용자는 즉시 느낀다. 잘 만들었다는 내 감(感)을 믿는 대신, 통과 기준을 숫자로 박아 두고 거기에 도달할 때까지 고친다.`})]})}function h(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(m,{...e})}):m(e)}var g=e({default:()=>y,frontmatter:()=>_}),_={title:`홈레이더 케이스 + 개인 레포 9편 자산화 + CodeRabbit 도입`,date:`2026-05-21 20:00`,type:`Shipped`,summary:`사이드 프로젝트(홈레이더)를 케이스로 정리하고, 6년치 개인 GitHub 레포 3개를 인터뷰 형식 9편으로 추출했다. 사이트 PR에 CodeRabbit 자동 리뷰를 붙였다.`};function v(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`한 일`}),`
`,(0,i.jsxs)(t.ul,{children:[`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/cases/home-radar-system`,children:`/cases/home-radar-system`}),`, `,(0,i.jsx)(t.a,{href:`/cases/personal-repos-interview`,children:`/cases/personal-repos-interview`}),`, `,(0,i.jsx)(t.a,{href:`/notes/coderabbit-cubic-double-review`,children:`/notes/coderabbit-cubic-double-review`})]})]})}function y(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(v,{...e})}):v(e)}var b=e({default:()=>C,frontmatter:()=>x}),x={title:`SPA를 크롤러가 읽게 만들기 — 빌드타임 prerender로 색인 강화`,date:`2026-06-02 21:00`,type:`Building`,summary:`React SPA는 크롤러에 빈 div로 보였다. 빌드 타임에 라우트 110개를 정적 HTML로 prerender하고 라우트별 canonical과 title을 주입해 색인을 살렸다.`};function S(e){let t={a:`a`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`맥락`}),`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/logs#2026-06-07-healthcheck-six-bots`,children:`/logs#2026-06-07-healthcheck-six-bots`})]})]})}function C(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(S,{...e})}):S(e)}var w=e({default:()=>D,frontmatter:()=>T}),T={title:`헬스체크를 6개 봇에 돌린 2주 — silent failure 사냥`,date:`2026-06-07 21:00`,type:`Shipped`,summary:`혼자 돌리는 자동화 여섯 개에 직접 헬스체크를 돌려, 에러 한 줄 안 내고 조용히 망가지던 경로 세 개를 잡아냈다. 그중 하나가 가든봇을 자동 작성으로 전환시켰다.`};function E(e){let t={a:`a`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`맥락`}),`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/essays/automation-doesnt-reduce-work`,children:`/essays/automation-doesnt-reduce-work`}),`, `,(0,i.jsx)(t.a,{href:`/logs#2026-06-08-writing-bot-reversal`,children:`/logs#2026-06-08-writing-bot-reversal`})]})]})}function D(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(E,{...e})}):E(e)}var O=e({default:()=>j,frontmatter:()=>k}),k={title:`글 안 쓰는 글쓰기 봇을 만들고, 2주 뒤 뒤집은 이유`,date:`2026-06-08 11:00`,type:`Building`,summary:`일부러 글을 못 쓰게 막아둔 주간 봇을, 2주치 운영 데이터를 읽고 자동 작성으로 뒤집었다. 지금 읽고 있는 이 글이 그 봇이 쓴 첫 결과물이다.`};function A(e){let t={a:`a`,h2:`h2`,p:`p`,strong:`strong`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(t.p,{children:[`지금 이 문단을 사람이 쓰지 않았다. 주간 봇이 내 지난 2주치 작업 이력과 대화 기록을 읽고 초안을 뽑았고, 나는 공개 전 한 번 검수만 했다. 2주 전만 해도 나는 이 봇이 글을 `,(0,i.jsx)(t.strong,{children:`못 쓰도록`}),` 코드로 막아둔 사람이었다.`]}),`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/logs#2026-06-07-healthcheck-six-bots`,children:`/logs#2026-06-07-healthcheck-six-bots`}),`, `,(0,i.jsx)(t.a,{href:`/essays/delegation-autonomy-calibration`,children:`/essays/delegation-autonomy-calibration`})]})]})}function j(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(A,{...e})}):A(e)}var M=e({default:()=>F,frontmatter:()=>N}),N={title:`CI 게이트를 매번 한 칸씩 조인다 — 안전망의 래칫`,date:`2026-06-09 11:00`,type:`Building`,summary:`AI가 PR을 쏟아내는 레포에서, 안전망을 한 번에 설계하는 대신 매주 한 칸씩 조이는 래칫으로 키웠다. secret-leak 가드, 커버리지 회귀 임계, 상태쓰기 concurrency 가드를 점진 추가했다.`};function P(e){let t={a:`a`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`맥락`}),`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/notes/learning-repo-sandbox-value`,children:`/notes/learning-repo-sandbox-value`})]})]})}function z(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(R,{...e})}):R(e)}var B=e({default:()=>U,frontmatter:()=>V}),V={title:`안전장치는 있느냐가 아니라 도는가로 본다 — 죽은 재시도와 거짓 runbook`,date:`2026-06-18 21:00`,type:`Building`,summary:`재시도 정책이 코드에 정의돼 있는데 호출자가 0건이었다. runbook은 자동 재시도된다고 안내하는데 실제로는 한 번도 돌지 않았다. 이번 주는 안전장치를 추가하는 게 아니라, 있다고 믿었지만 돌지 않던 장치들을 골라내는 일이었다.`};function H(e){let t={h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`맥락`}),`
...
`,(0,i.jsxs)(t.p,{children:[`관련: `,(0,i.jsx)(t.a,{href:`/essays/deterministic-design-loop`,children:`/essays/deterministic-design-loop`})]})]})}function q(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,i.jsx)(t,{...e,children:(0,i.jsx)(K,{...e})}):K(e)}export{O as a,g as c,r as d,M as i,f as l,B as n,w as o,I as r,b as s,W as t,c as u};