...
[/notes/code-review-comment-tone](/notes/code-review-comment-tone) — 결정 질문은 단정형이 아니라 질문형 톤이어야 답을 끌어낸다
[/notes/async-pr-review-slo](/notes/async-pr-review-slo) — 리뷰 SLO가 결정 중심 리뷰의 시간 자원을 만든다
[/notes/coderabbit-cubic-double-review](/notes/coderabbit-cubic-double-review) — 자동 리뷰는 결정보다 코드만 봄, 사람 리뷰는 결정 자리
